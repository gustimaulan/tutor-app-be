...
-- Attendance records table with proper foreign key relationships
CREATE TABLE IF NOT EXISTS attendance_records (
    ...
    student_name VARCHAR(255) NOT NULL, -- Keep for backward compatibility
    student_id UUID NOT NULL REFERENCES students(id), -- NEW: Proper foreign key
...
CREATE INDEX idx_attendance_student_id ON attendance_records(student_id); -- NEW: Index on foreign key
...
-- Insert sample attendance data with proper foreign key relationships
INSERT INTO attendance_records (tutor_name, email, tutoring_date, tutoring_time, student_name, student_id, proof_of_teaching) VALUES 
('DZIHNI SHAFA SALSABILA', 'dzihni@example.com', '2025-07-21', '18:30:00', 'AUFA - AQRA', (SELECT id FROM students WHERE name = 'AUFA - AQRA'), 'https://example.com/bukti1.jpg'),
('ALIYAH HANUN', 'aliyah@example.com', '2025-07-21', '17:00:00', 'AALONA', (SELECT id FROM students WHERE name = 'AALONA'), 'https://example.com/bukti2.jpg'),
('ALIYAH HANUN', 'aliyah@example.com', '2025-07-19', '16:00:00', 'UBAIDILLAH FIDEL MAHARDIKA', (SELECT id FROM students WHERE name = 'UBAIDILLAH FIDEL MAHARDIKA'), 'https://example.com/bukti3.jpg'),
('ARIFFINA ERMA R', 'ariffina@example.com', '2025-07-18', '19:00:00', 'RYUGA', (SELECT id FROM students WHERE name = 'RYUGA'), 'https://example.com/bukti4.jpg'),
('ARIFFINA ERMA R', 'ariffina@example.com', '2025-07-14', '18:30:00', 'RYUGA', (SELECT id FROM students WHERE name = 'RYUGA'), 'https://example.com/bukti5.jpg'); 